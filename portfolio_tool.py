...
# ============================================================
# SECTION: HELPER FUNCTIONS & GEMINI PDF FILE EXTRACTION
# ============================================================
def safe_float(v):
    try:
...
def process_pdf_ffs_with_gemini(uploaded_pdfs):
    ...
    # Candidate models for multimodal PDF analysis
    candidate_models = [
        'gemini-1.5-flash',
        'gemini-1.5-pro'
    ]
    ...
    for idx, pdf_file in enumerate(uploaded_pdfs):
        ...
        # Save temporary local copy for File API upload
        ...
        try:
            ...
            # Cleanup temp file on disk and in Gemini cloud
...
if not st.session_state.authenticated:
    ...
    if st.session_state.page == 'home':
        ...
        # Display Interactive Verification Table
        ...
        primary_benchmark = benchmark_names[0] if len(benchmark_names) >